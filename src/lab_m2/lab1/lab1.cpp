...
void Lab1::Init()
{
    ...
    CreateFramebuffer(light_width, light_height);
}
...
void Lab1::DrawScene(Shader *shader)
{
    for (int i = 0; i < 16; i++)
    {
...
void Lab1::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, Texture2D* texture)
{
...
void Lab1::DrawFramebufferTextures()
{
...
void Lab1::RenderTextureScreen(Shader *shader, unsigned int textureID)
{
...
void Lab1::LoadShader(const std::string& name)
{
    std::string shaderPath = PATH_JOIN(window->props.selfDir, SOURCE_PATH::M2, "lab1", "shaders");
